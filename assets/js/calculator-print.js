...
;(function() {
  ...
  const PrintUtil = {
    ...
    legalDisclaimer: `
      <strong>⚠️ IMPORTANT LEGAL NOTICE</strong><br><br>
      This calculation is generated by VetLudics, an educational tool for veterinary professionals and students.<br><br>
      ...
      <strong>LIABILITY:</strong> VetLudics and its operators assume no liability for clinical decisions made using this tool. 
      The user assumes full responsibility for verifying all calculations and ensuring patient safety.<br><br>
      Generated: ${new Date().toLocaleString()} | vetludics.com | For educational use only.
    `,
    ...
    printHeader: `
      <div class="print-header-meta">
        ...
        <span>🌐 parthchaudhari.com/tools/</span>
      </div>
    `,
        ...
        <div class="pc-calc-dashboard">
          ...
          <header class="pc-calc-header">
            <div class="pc-calc-header__title">
              <div class="pc-calc-header__icon">${data.icon || '📊'}</div>
          ...
          <section class="pc-calc-results">
            <div class="pc-calc-panel">
              <div class="pc-calc-panel__header">
                <span class="pc-calc-panel__title">📋 Calculation Results</span>
              </div>
        ...
        content += `
          <section class="pc-calc-viz page-break-avoid">
            <div class="pc-calc-viz__header">
              <span class="pc-calc-viz__title">💊 Drug Information</span>
            </div>
        ...
        content += `
          <section class="page-break-avoid">
            <div class="pc-calc-alert pc-calc-alert--warning">
              <div class="pc-calc-alert__icon">⚠️</div>
    ...
    extractDataFromPage: function(calculatorType) {
      const data = {
        ...
        icon: document.querySelector('.pc-calc-header__icon')?.textContent || '📊'
      }
      ...
      if (species || weight) {
        data.patient = {
          species: species === 'dog' ? '🐕 Dog' : species === 'cat' ? '🐈 Cat' : species,
          weight: weight
        }
      }
