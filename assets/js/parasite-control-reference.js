(function () {
    ...
    var STAGE_NOTES = {
        dog: {
            puppy: 'Start nematode deworming at 2, 4, 6, and 8 weeks, then transition to broad-spectrum monthly prevention.',
            adult: 'Keep year-round prevention and update protocol after travel, daycare exposure, or GI signs.',
            senior: 'Recheck body weight and comorbidities often to avoid underdosing and interactions.'
        },
        cat: {
            kitten: 'Deworm at 3, 5, 7, and 9 weeks, then continue monthly prevention as weight allows.',
            adult: 'Maintain consistent flea and internal parasite prevention even for mostly indoor cats.',
            senior: 'Adjust product selection for chronic disease and monitor tolerance with each recheck.'
        }
    };
        ...
        dog: [
            {
                ...
                baseline: 'Fecal flotation every 6-12 months plus broad-spectrum prevention.',
                byRisk: {
                    low: 'Fecal flotation every 12 months; monthly broad-spectrum prevention.',
                    moderate: 'Fecal flotation every 6 months; monthly broad-spectrum prevention.',
                    high: 'Fecal flotation every 3-4 months; monthly prevention plus post-exposure checks.'
                },
                reminder: 'Treat in-contact pets and repeat fecal test after positive cases.'
            },
            {
                focus: 'Heartworm',
                ...
                byRisk: {
                    ...
                    moderate: 'Year-round prevention; antigen test every 12 months and after missed doses.',
                    high: 'Strict year-round prevention; antigen test every 6-12 months in high mosquito areas.'
                },
                reminder: 'Run confirmatory testing and microfilaria assessment if positive.'
            },
            {
                focus: 'Flea and Tick Control',
                baseline: 'Continuous ectoparasite control with environmental management.',
                byRisk: {
                ...
                reminder: 'Treat all household pets and clean bedding/environment to reduce reinfestation.'
            },
            {
                focus: 'Public Health and Zoonosis',
                baseline: 'Routine hygiene, feces disposal, and family risk counseling.',
                byRisk: {
                    low: 'Reinforce hand hygiene and routine stool disposal.',
                    moderate: 'Reinforce hygiene plus monthly reminder on child/immunocompromised safety.',
                    high: 'Provide written zoonosis instructions and stricter feces disposal guidance.'
                },
                reminder: 'Escalate counseling when households include children, seniors, or immunocompromised people.'
            }
        ],
        cat: [
            {
                focus: 'Fecal Testing and Intestinal Parasites',
                baseline: 'Fecal testing every 6-12 months with monthly broad-spectrum prevention.',
                byRisk: {
                ...
                reminder: 'Outdoor and hunting cats need tighter interval checks for tapeworm and roundworm risk.'
            },
            {
                focus: 'Heartworm (Regional Risk)',
                baseline: 'Use monthly prevention where vectors are present and test based on clinical suspicion.',
                byRisk: {
                    low: 'Discuss prevention even for indoor cats in endemic regions.',
                    moderate: 'Monthly prevention during vector season or year-round based on local risk.',
                    high: 'Year-round prevention in endemic areas with workup if respiratory or GI signs develop.'
                },
                reminder: 'No single test excludes feline heartworm; combine history, imaging, and antigen/antibody context.'
            },
            {
                focus: 'Flea, Tick, and Mite Control',
                baseline: 'Consistent ectoparasite prevention with household-level treatment.',
                byRisk: {
                ...
                reminder: 'Confirm products are feline-safe; avoid canine permethrin products.'
            },
            {
                focus: 'Public Health and Zoonosis',
                ...
                byRisk: {
                    ...
                    moderate: 'Daily litter disposal plus routine zoonosis review during wellness visits.',
                    high: 'Daily litter disposal with stricter counseling for pregnant or immunocompromised household members.'
                },
                reminder: 'Review toxoplasmosis and hookworm precautions during preventive visits.'
            }
        ]
    };
    ...
    function renderProtocol() {
        ...
        setText('parasite-note', 'Protocol generated for ' + species.toUpperCase() + ' | ' + RISK_LABELS[risk] + '.');
    }
    ...
    function copyProtocol() {
        ...
        lines.push('');
        lines.push('Educational use only. Verify with local protocols and product labels.');
