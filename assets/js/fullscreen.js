(function () {
        ...
        for (var i = 0; i < buttons.length; i += 1) {
            (function (button) {
                ...
                button.addEventListener('click', function () {
                    var targetSelector = button.getAttribute('data-pc-target') || '[data-pc-fullscreen-target]';
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initFullscreenButtons, { once: true });
    } else {
